...
// ====================================== Searching Articles
Search.prototype.searchArticles = function (searchString) {
  var searchContent = typeof searchString === 'object' ? searchString : {query : searchString};
  return this.request('GET', ['articles', 'search'], searchContent);
};

// ====================================== Searching Articles In Locale
Search.prototype.searchArticlesInLocale = function (searchString, locale) {
  var searchContent = {query : searchString, locale: locale};
  return this.request('GET', ['articles', 'search'], searchContent);
};

// ====================================== Searching Articles By Labels
Search.prototype.searchArticlesByLabels = function (labelNames) {
  var searchContent = typeof labelNames === 'object' ? labelNames : {label_names : labelNames};
  return this.request('GET', ['articles'], searchContent);
};

// ====================================== Searching Questions
Search.prototype.searchQuestions = function (searchString) {
  //Do not need requesetAll
  var searchContent = typeof searchString === 'object' ? searchString : {query : searchString};
  return this.request('GET', ['questions', 'search'], searchContent);
};
