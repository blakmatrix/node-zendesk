...
GreetingCategories.prototype.list = function() {
  return this.request('GET', ['greeting_categories']);
};

// ====================================== Get Greetings Category by ID
GreetingCategories.prototype.show = function(greetingCategoryID) {
  return this.request('GET', ['greeting_category', greetingCategoryID]);
};
