...
Availabilities.prototype.update = function(agentID, availability) {
  return this.request('PUT', ['availabilities', agentID], availability);
};

// ====================================== Get Availabilities by ID
Availabilities.prototype.show = function(agentID) {
  return this.request('GET', ['availabilities', agentID]);
};
