...
exports.createClient = function (options) {
  ...
  if (options.stores.defaults.store.helpcenter) {
    ...
    clientPath = options.supportPromises ? './promise-client/helpcenter/' : './client/helpcenter/';
  } else if (options.stores.defaults.store.voice) {
    partsToAdd = voiceParts;
    clientPath = options.supportPromises ? './promise-client/voice/' : './client/voice/';
  } else {
    partsToAdd = parts;
    clientPath = options.supportPromises ? './promise-client/' : './client/';
  }
