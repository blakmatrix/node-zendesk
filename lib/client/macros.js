...
Macros.prototype.show = function (id, cb) {
  return this.request('GET', ['macros', id], cb);
};
...
Macros.prototype.actions = function (cb) {
  return this.request('GET', ['macros', 'actions'], cb);
};

Macros.prototype.definitions = function (cb) {
  return this.request('GET', ['macros', 'definitions'], cb);
};