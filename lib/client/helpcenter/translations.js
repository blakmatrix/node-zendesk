...
const Translations = (exports.Translations = function (options) {
...
//  locales=en-us,en-uk
//  outdated=true
Translations.prototype.listByArticle = function (
  articleID,
  filterParameters,
  cb,
) {
...
Translations.prototype.listMissingLocalesByArticle = function (articleID, cb) {
  return this.request(
    'GET',
    ['articles', articleID, 'translations', 'missing'],
    cb,
  );
};
...
Translations.prototype.listMissingLocalesBySection = function (sectionID, cb) {
  return this.request(
    'GET',
    ['sections', sectionID, 'translations', 'missing'],
    cb,
  );
};

// ====================================== Listing Translations Belongs To A Category
Translations.prototype.listMissingLocalesByCategory = function (
  categoryID,
  cb,
) {
  return this.request(
    'GET',
    ['categories', categoryID, 'translations', 'missing'],
    cb,
  );
};

// ====================================== Creating Translations For An Article
Translations.prototype.createForArticle = function (
  articleID,
  translation,
  cb,
) {
...
Translations.prototype.createForSection = function (
  sectionID,
  translation,
  cb,
) {
  return this.request(
    'POST',
    ['sections', sectionID, 'translations'],
    translation,
    cb,
  );
};
...
Translations.prototype.createForCategory = function (
  categoryID,
  translation,
  cb,
) {
...
Translations.prototype.updateForArticle = function (
  articleID,
  locale,
  translation,
  cb,
...
Translations.prototype.updateForSection = function (
  sectionID,
  locale,
  translation,
  cb,
...
Translations.prototype.updateForCategory = function (
  categoryID,
  locale,
  translation,
  cb,
