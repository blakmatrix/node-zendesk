...
const Sections = (exports.Sections = function (options) {
...
Sections.prototype.createWithLocale = function (
  locale,
  categoryId,
  section,
  cb,
...
Sections.prototype.updateWithLocale = function (
  locale,
  sectionID,
  section,
  cb,
...
Sections.prototype.updateSourceLocale = function (sectionID, sourceLocale, cb) {
  return this.request(
    'PUT',
    ['sections', sectionID, 'source_locale'],
    sourceLocale,
    cb,
  );
};
