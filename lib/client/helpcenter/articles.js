...
const Articles = (exports.Articles = function (options) {
...
Articles.prototype.listByCategoryByLocale = function (locale, categoryID, cb) {
  this.requestAll('GET', [locale, 'categories', categoryID, 'articles'], cb); // All
};
...
Articles.prototype.listByLabelNames = function (labelNames, cb) {
  return this.requestAll(
    'GET',
    ['articles', {label_names: labelNames.toString()}],
    cb,
  ); // All
};
...
Articles.prototype.createWithLocale = function (
  locale,
  sectionID,
  article,
  cb,
...
Articles.prototype.updateWithLocale = function (
  locale,
  articleID,
  article,
  cb,
...
Articles.prototype.associateAttachmentsInBulk = function (
  articleID,
  attachmentIDsInBulk,
  cb,
) {
