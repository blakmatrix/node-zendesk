...
// ====================================== Listing translations for an article
Articles.prototype.listTranslations = function(articleID, optionalQueryParams, cb) {
  if (typeof optionalQueryParams === 'object') {
    this.request('GET', ['help_center', 'articles', articleID, 'translations', optionalQueryParams], cb);
  }
};
