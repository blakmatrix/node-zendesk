...
OrganizationMemberships.prototype.list = function (cb) {
  return this.requestAll('GET', ['organization_memberships', '?page[size]=100'], cb);//all
};

OrganizationMemberships.prototype.listByUser = function (userID, cb) {
  return this.requestAll('GET', ['users', userID, 'organization_memberships','?page[size]=100'], cb);//all
};

OrganizationMemberships.prototype.listByOrganization = function (organiationID, cb) {
  return this.requestAll('GET', ['organizations', organiationID, 'organization_memberships', '?page[size]=100'], cb);//all
};
