...
const OrganizationMemberships = (exports.OrganizationMemberships = function (
  options,
) {
...
OrganizationMemberships.prototype.list = function (cb) {
  return this.requestAll(
    'GET',
    ['organization_memberships', '?page[size]=100'],
    cb,
  ); // All
};
...
OrganizationMemberships.prototype.listByOrganization = function (
  organiationID,
  cb,
) {
  return this.requestAll(
...
OrganizationMemberships.prototype.show = function (
...
OrganizationMemberships.prototype.showByUser = function (
  userID,
  organizationMembershipID,
  cb,
) {
...
OrganizationMemberships.prototype.create = function (
...
OrganizationMemberships.prototype.createByUser = function (
  userID,
  organizationMembership,
  cb,
) {
...
OrganizationMemberships.prototype.createMany = function (
...
OrganizationMemberships.prototype.delete = function (
  organizationMembershipID,
  cb,
) {
  return this.request(
...
OrganizationMemberships.prototype.deleteByUser = function (
  userID,
  organizationMembershipID,
  cb,
) {
...
OrganizationMemberships.prototype.deleteMany = function (
...
OrganizationMemberships.prototype.makeDefault = function (
  userID,
  organizationMembershipID,
  cb,
) {
