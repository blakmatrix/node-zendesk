...
UserIdentities.prototype.show = function (userID, userIDentityID, cb) {
  return this.request('GET', ['users', userID, 'identities', userIDentityID], cb);
};
...
UserIdentities.prototype.create = function (userID, userIDentity, cb) {
  ...
  return this.request('POST', ['users', userID, 'identities'], userIDentity, cb);
};
...
UserIdentities.prototype.makePrimary = function (userID, userIDentityID,  cb) {
  return this.request('PUT', ['users', userID, 'identities', userIDentityID, "make_primary"],   cb);
};

UserIdentities.prototype.verify = function (userID, userIDentityID, cb) {
  return this.request('PUT', ['users', userID, 'identities', userIDentityID, 'verify'],   cb);
};

UserIdentities.prototype.requestVerification = function (userID, userIDentityID, cb) {
  return this.request('PUT', ['users', userID, 'identities', userIDentityID, 'request_verification'],   cb);
};

// ====================================== Deleting UserIdentities
UserIdentities.prototype.delete = function (userID, userIDentityID, cb) {
  return this.request('DELETE', ['users', userID, 'identities', userIDentityID],  cb);
};
