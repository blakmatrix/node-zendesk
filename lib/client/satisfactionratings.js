...
const SatisfactionRatings = (exports.SatisfactionRatings = function (options) {
...
SatisfactionRatings.prototype.list = function (cb) {
  return this.requestAll(
    'GET',
    ['satisfaction_ratings', '?page[size]=100'],
    cb,
  ); // All
};
...
SatisfactionRatings.prototype.show = function (satisfactionRatingID, cb) {
  return this.request(
    'GET',
    ['satisfaction_ratings', satisfactionRatingID],
    cb,
  ); // All
};

// ====================================== Posting SatisfactionRatings
SatisfactionRatings.prototype.create = function (
  ticketID,
  satisfactionRating,
  cb,
) {
