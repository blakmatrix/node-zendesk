...
const Views = (exports.Views = function (options) {
...
Views.prototype.execute = function (viewID, parameters, cb) {
  return this.requestAll('GET', ['views', viewID, 'execute', parameters], cb);
};
...
// :params can be http://developer.zendesk.com/documentation/rest_api/views.html#previewing-views
Views.prototype.preview = function (parameters, cb) {
  return this.requestAll('POST', ['views', 'preview'], parameters, cb);
};
