...
const Organizations = (exports.Organizations = function (options) {
...
Organizations.prototype.search = function (parameters, cb) {
  return this.requestAll('GET', ['organizations', 'search', parameters], cb);
};

// ====================================== Autocomplete Organizations
Organizations.prototype.autocomplete = function (parameters, cb) {
  return this.requestAll(
    'GET',
    ['organizations', 'autocomplete', parameters],
    cb,
  );
};
