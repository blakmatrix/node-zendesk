...
Attachments.prototype.upload = function (file, fileOptions, cb) {
  ...
  // When attaching multiple files, a token is returned in the successful 201 response.
  // This token can be used in subsequent requests in order to associated the attachments with an upload. 
