...
const TopicSubscriptions = (exports.TopicSubscriptions = function (options) {
...
TopicSubscriptions.prototype.create = function (
  topicId,
  topicSubscription,
  cb,
) {
...
TopicSubscriptions.prototype.delete = function (topicSubscriptionsID, cb) {
  return this.request(
    'DELETE',
    ['topic_subscriptions', topicSubscriptionsID],
    cb,
  );
};
