...
const Tickets = (exports.Tickets = function (options) {
...
Tickets.prototype.listWithFilter = function (type, value, cb) {
  return this.requestAll(
    'GET',
    ['tickets', {[type]: value}, '?page[size]=100'],
    cb,
  );
};
...
Tickets.prototype.export = function (startTime, cb) {
  return this.request(
    'GET',
    ['exports', 'tickets', {start_time: startTime}],
    cb,
  );
};
...
Tickets.prototype.incremental = function (startTime, cb) {
  return this.requestAll(
    'GET',
    ['incremental', 'tickets', {start_time: startTime}],
    cb,
  );
};
